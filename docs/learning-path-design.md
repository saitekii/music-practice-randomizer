...
As of 2026-07-13: **128 stages across 19 phases.**
...
4. **Once key fluency is well-established elsewhere in the path, later phases don't need their own granular key ramp.** Used deliberately in the borrowed-chords/jazz-extension phase 17 content (2-stage ramp, not the original 5-stage one) and when trimming the second audit round's redundant ramps — by phase 14+, a learner has already drilled all 12 keys many times over in earlier phases.
...
Critique item: reordering enharmonics (Phase 15 today) to sit right after this phase would make these accidental-heavy stages easier, since F♯/G♭ equivalence would already be known. **Not yet done** — see Open Issues.
...
### 10. Combine chords + scales (3 stages)
...
### 11. Seventh chords — root position (4 stages)
...
### 12. Seventh chord inversions (5 stages)
...
### 14. Scales beyond natural minor (15 stages)
...
- [[chord-progressions-learning-path-deferred]] — full history of Phase 17's content buildup and the still-deferred `Modern Harmony Reference.md` Section 4
- [[left-hand-mode-deferred]] — Phase 7's feature architecture and why it doesn't generalize past Major/Minor root position yet
- [[functional-harmony-canonical-numeral-fix]] — the pre-existing bug that silently affected all of Phase 17 until 2026-07-13
- [[tonal-jazz-extensions]], [[secondary-dominants]] — the two most recent content additions to Phase 17
